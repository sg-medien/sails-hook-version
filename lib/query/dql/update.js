...
var usageError = require('sails-hook-orm/node_modules/waterline/lib/waterline/utils/usageError');
var utils = require('sails-hook-orm/node_modules/waterline/lib/waterline/utils/helpers');
var normalize = require('sails-hook-orm/node_modules/waterline/lib/waterline/utils/normalize');
var Deferred = require('sails-hook-orm/node_modules/waterline/lib/waterline/query/deferred');
var callbacks = require('../../utils/callbacksRunner');
var nestedOperations = require('sails-hook-orm/node_modules/waterline/lib/waterline/utils/nestedOperations');
...
function beforeCallbacks(valuesObject, cb) {
  ...
  async.series([
    ...
    function(cb) {
      callbacks.validate(self, valuesObject.values, true, cb);
    },
